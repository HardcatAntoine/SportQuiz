...
import com.chestbox.app.databinding.FragmentBasketballBinding
import com.google.gson.Gson
import com.google.gson.reflect.TypeToken
import java.io.IOException


class BasketballFragment : Fragment(), View.OnClickListener {
    ...
    fun getBasketballQuestions(context: Context): List<Questions> {
        ...
        try {
            jsonString =
                context.assets.open("basketball/basketball.json").bufferedReader().use { it.readText() }
