...
class HockeyFragment : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        binding = FragmentHockeyBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    private fun setQuestion() {
        ...
        if (mCurrentPosition == mQuestionsList!!.size) {
            ...
            binding.btnSubmit.setOnClickListener {
                val action =
                    HockeyFragmentDirections.actionHockeyFragmentToResultFragment(
                        mCorrectAnswers
                    )
    ...
    fun getHockeyQuestions(context: Context): List<Questions> {
        ...
        try {
            jsonString =
                context.assets.open("hockey/hockey.json").bufferedReader().use { it.readText() }
