...
import com.chestbox.app.databinding.FragmentAllQuestionsBinding
import com.chestbox.app.databinding.FragmentHockeyBinding
import com.google.gson.Gson
import com.google.gson.reflect.TypeToken
import java.io.IOException

class AllQuestionsFragment : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        binding = FragmentAllQuestionsBinding.inflate(layoutInflater)
        return binding.root
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        mQuestionsList = getAllQuestions(requireContext())
    ...
    fun getAllQuestions(context: Context): List<Questions> {
        ...
        try {
            jsonString =
                context.assets.open("all/all.json").bufferedReader().use { it.readText() }
